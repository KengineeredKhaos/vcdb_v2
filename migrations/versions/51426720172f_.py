...
Revision ID: 51426720172f
Revises: 
Create Date: 2026-03-14 12:32:42.077915
...
def upgrade():
    ...
    sa.Column('needs_state', sa.String(length=24), nullable=False),
    ...
    sa.CheckConstraint("needs_state IN ('not_started','in_progress','complete','skipped')", name='ck_customer_needs_state_enum'),
    ...
    with op.batch_alter_table('customer_customer', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_customer_customer_needs_state'), ['needs_state'], unique=False)
    ...
    sa.Column('homeless_status', sa.String(length=16), nullable=False),
    ...
    with op.batch_alter_table('customer_eligibility', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_customer_eligibility_homeless_status'), ['homeless_status'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('customer_eligibility', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_customer_eligibility_homeless_status'))
    ...
    with op.batch_alter_table('customer_customer', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_customer_customer_needs_state'))
